        ...
        header: function(){
         ...
         section4:function(){
             ...
             function gallery(){
                 ...
                 $('.gallery li').eq(2).show().animate({top: 0, left:'75%'}, 300);
                 $('.gallery li').eq(3).show().animate({top: 0, left:'50%'}, 300);

                 $('.gallery li').eq(4).show().animate({top: h, left:'0'}, 300);
                 $('.gallery li').eq(5).show().animate({top: h, left:'50%'}, 300);
                 $('.gallery li').eq(6).show().animate({top: h, left:'25%'}, 300);
                 ...
                 if(nb==1){
                     ...
                     $('.gallery li').eq(1).show().animate({top: 0, left:'0'}, 300);
                     $('.gallery li').eq(3).show().animate({top: 0, left:'50%'}, 300);
                     $('.gallery li').eq(4).show().animate({top: 0, left:'75%'}, 300);
                     $('.gallery li').eq(5).show().animate({top: 0, left:'25%'}, 300);

                     $('.gallery li').eq(6).show().animate({top: h, left:'0'}, 300);
                 }
                 ...
                 if(nb==2){
                     ...
                     $('.gallery li').eq(1).show().animate({top: 0, left:'0'}, 300);
                     $('.gallery li').eq(2).show().animate({top: 0, left:'25%'}, 300);
                     $('.gallery li').eq(3).show().animate({top: 0, left:'50%'}, 300);
                     $('.gallery li').eq(4).show().animate({top: 0, left:'75%'}, 300);

                     $('.gallery li').eq(5).show().animate({top: h, left:'0'}, 300);
                     $('.gallery li').eq(6).show().animate({top: h, left:'25%'}, 300);
                 }
                 if(nb==3){
                     ...
                     $('.gallery li').eq(0).show().animate({top: 0, left:'0'}, 300);
                     $('.gallery li').eq(2).show().animate({top: 0, left:'25%'}, 300);
                     $('.gallery li').eq(4).show().animate({top: 0, left:'50%'}, 300);
                     $('.gallery li').eq(5).show().animate({top: 0, left:'75%'}, 300);
                 }
                 ...
                 if(nb==4){
                     ...
                     $('.gallery li').eq(0).show().animate({top: 0, left:'0'}, 300);
                     $('.gallery li').eq(7).show().animate({top: 0, left:'25%'}, 300);
                 }
                 if(nb==5){
                     $('.gallery li').eq(0).hide();
                     $('.gallery li').eq(2).hide();
                     ...
                     $('.gallery li').eq(1).show().animate({top: 0, left:'0'}, 300);
                     $('.gallery li').eq(3).show().animate({top: 0, left:'25%'}, 300);
                     $('.gallery li').eq(6).show().animate({top: 0, left:'50%'}, 300);
                 }
